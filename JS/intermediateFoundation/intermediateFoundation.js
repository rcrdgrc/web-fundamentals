...
// Factorial - Write a function factorial(num) that, given a number, returns the product (multiplication) of all positive integers 
...
// Fibonacci - Create a function to generate Fibonacci numbers.  In this famous mathematical sequence, each number is the sum of the
// previous two, starting with values 0 and 1.  Your function should accept one argument, an index into the sequence 
...
function fibonacci(index) {
    ...
    let sum = fibSequence[fibSequence.length - 2] + fibSequence[fibSequence.length - 3];

    return index === 0 ? 0 : sum
}
...
// Array: Nth-to-Last: Return the element that is N-from-array's-end.  Given ([5,2,3,6,4,9,7],3), return 4.  If the array is 
...
// Array: Second-Largest: Return the second-largest element of an array. Given [42,1,4,3.14,7], return 7.  If the array is too short,
// return null.
...
function doubleTrouble(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        imSeeingDouble.push(ele);
        imSeeingDouble.push(ele);
    }

    return imSeeingDouble
}
